...
var wisdoms = [
  ...
  "Life is short, take that leap!",
  "Never give up.",
  "You are just as smart as the person you're comparing yourself to."
]
...
class App extends Component {
  constructor(props) {
    ...
    this.timer = setInterval(this.addRandomWisdom, 15000);
  ...
  setRandomWisdom() {
    ...
    if (this.state.wisdom==wisdoms[index]){
      var index = Math.floor(Math.random() * wisdoms.length);
    // if (this.state.wisom == wisdoms[index]) {
      //   console.log("omg again?");
     // }
    }
    this.setState({
      wisdom: wisdoms[index]
